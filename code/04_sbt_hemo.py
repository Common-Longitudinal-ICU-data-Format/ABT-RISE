...
def _(df, pl):
    ...
    # SBT eligibility: IMV + no paralytics + hemodynamic stability (no sedation requirement)
    _overnight_flags = (
    ...
    _day_flags = _day_flags.with_columns(
        ...
        .when(~pl.col("has_hemo_stable")).then(pl.lit("Hemodynamic instability"))
    ...
    _n_hemo_stable = _day_flags.filter(pl.col("has_overnight_data") & pl.col("has_imv") & pl.col("has_hemo_stable")).height

    consort_partial = {
        "total": _total, "n_overnight": _n_overnight, "n_imv": _n_imv, "n_hemo_stable": _n_hemo_stable,
    }
...
def _(
    ...
    _n_not_hemo = consort_partial["n_imv"] - consort_partial["n_hemo_stable"]
    _n_not_elig = max(0, consort_partial["n_hemo_stable"] - _n_elig)
    ...
    consort_sbt = [
        ...
        {"step": 2, "description": "Days with IMV (22:00–06:00)",
         ...
         "reason": "No IMV"},
        {"step": 3, "description": "Days with hemodynamic stability (NEE ≤ 0.2)",
         "remaining": consort_partial["n_hemo_stable"],
         "excluded": _n_not_hemo, "reason": "Hemodynamic instability"},
        {"step": 4, "description": "Eligible days (≥6h IMV, no paralytics, hemo stable)",
         "remaining": _n_elig,
